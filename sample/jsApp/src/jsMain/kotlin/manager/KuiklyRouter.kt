...
object KuiklyRouter {
    ...
    // The GearUI sample has a single @Page("MainDemo") entry point and manages navigation internally;
    // the "router" page the official template defaults to belongs to the KuiklyUI demo and does not exist here.
