...
object ComponentConfig {
    val all: List<ComponentInfo> = listOf(
        ...
        ComponentInfo("tab", "选项卡", "Tab", ComponentCategory.NAVIGATION, "/components/tab", "内容切换", "Content switching"),
        ComponentInfo("sidebar", "侧边栏", "Sidebar", ComponentCategory.NAVIGATION, "/components/sidebar", "侧边导航", "Side navigation"),
        ComponentInfo("tabbar", "底部导航", "TabBar", ComponentCategory.NAVIGATION, "/components/tabbar", "底部导航栏", "Bottom navigation"),
